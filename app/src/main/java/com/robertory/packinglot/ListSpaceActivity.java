...
public class ListSpaceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent payIntent=new Intent(ListSpaceActivity.this,PayActivity.class);
...
//                        txtResponse.setText("Code : "+response.code());
                    ...
                    tvParkName.setText(finalSelectedPark);
                    activeSensors=response.body().stream()
                            .filter((sensor) -> finalSelectedPark.equals(sensor.getName().split("#")[0]))
                            .collect(Collectors.toList());

                    RecyclerView.LayoutManager layoutManager = new GridLayoutManager(ListSpaceActivity.this,2);
                    rvSpaces.setLayoutManager(layoutManager);

                    SpaceListAdapter adapter = new SpaceListAdapter(ListSpaceActivity.this, activeSensors);
